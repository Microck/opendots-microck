...
- **MCP Servers**
  ...
  - `motion` - Generate CSS easing helpers: create spring-like and bounce-like linear() transitions tuned by duration/bounce for UI animation. Source: https://api.motion.dev/registry.tgz?package=motion-studio-mcp&version=latest ([package](https://www.npmjs.com/package/motion-studio-mcp))
