...
```bash
PHASE_DIR=$(node /home/ubuntu/.config/opencode/get-shit-done/bin/gsd-tools.js find-phase "$PHASE_ARG" --raw)
...
```bash
node /home/ubuntu/.config/opencode/get-shit-done/bin/gsd-tools.js commit "fix($PHASE): revise plans based on checker feedback" --files .planning/phases/$PHASE-*/$PHASE-*-PLAN.md
```
...
```bash
COMMIT_PLANNING_DOCS=$(node /home/ubuntu/.config/opencode/get-shit-done/bin/gsd-tools.js state load --raw | grep '^commit_docs=' | cut -d= -f2)
```
</step>
...
```bash
PHASE_DIR=$(node /home/ubuntu/.config/opencode/get-shit-done/bin/gsd-tools.js find-phase "$PHASE" --raw)
...
```bash
node /home/ubuntu/.config/opencode/get-shit-done/bin/gsd-tools.js commit "docs($PHASE): create phase plan" --files .planning/phases/$PHASE-*/$PHASE-*-PLAN.md .planning/ROADMAP.md
```
</step>
