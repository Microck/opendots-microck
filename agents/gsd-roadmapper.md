...
Use template from `/home/ubuntu/.config/opencode/get-shit-done/templates/roadmap.md`.
...
Use template from `/home/ubuntu/.config/opencode/get-shit-done/templates/state.md`.
